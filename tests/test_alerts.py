...
def test_case1(driver_setup_teardown):
    ...
    log_info("STEP 3: Click on 'Click Button to see alert' button")
    ...
    log_info("STEP 5: Click on 'On button click, confirm box will appear' button")
    ...
    log_info("STEP 6: Click on OK button")
    alerts_page.accept_alert()
    ...
    log_info("STEP 7: Click on 'On button click, prompt box will appear' button")
    ...
    log_info("STEP 8: Enter randomly generated text, click OK button...")
    text_input = alerts_page.send_random_input_to_prompt()
    log_info("STEP 8: ...click OK button")
    alerts_page.accept_alert()
    error_message_step8 = (
